  ...
  return (
    <Dialog.Root open={open}>
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed top-2/4 left-2/4 -translate-x-2/4 -translate-y-2/4 flex flex-col rounded bg-light-gray-100 overflow-hidden animate-overlayContent focus:outline-none shadow-xl z-30">
          ...
          <div className="relative flex h-max">
                ...
                <div className="flex gap-8">
                  <div className="flex flex-col gap-4 max-w-[400px]">
                    <p className="text-center">
                      GoRestaurant é uma plataforma que oferece serviço de venda
                      de alimentos pela internet com entrega ou retirada no
                      local.
                    </p>
                    <span className="indent-4 text-justify">
                      O usuário acessa a plataforma, seleciona um local para
                      entrega, a plataforma oferece todos os restaurantes da sua
                      região, o usuário escolhe sua comida favorita, fecha o
                      pedido e então recebe a comida. Também temos um sistema de
                      avaliação de comidas, mas para apenas usuários cadastrados
                      e que já fizeram pedidos. A avaliação é um termômetro
                      indicando os melhores restaurantes e comidas.
                    </span>
                    <a
                      href="https://github.com/die-goncalves/go-restaurant"
                      target="_blank"
            ...
            <div className="relative left-0 top-0 bottom-0 w-72">
