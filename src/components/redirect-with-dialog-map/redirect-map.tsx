...
type RedirectMapProps = {
  onCoordinatesChange: (coord: { lat: number; lng: number }) => void
}
export function RedirectMap({ onCoordinatesChange }: RedirectMapProps) {
  ...
  useEffect(() => {
    ...
    map.current.on('move', e => {
      ...
      const pinElement = document.getElementById('pin-redirect-map')
