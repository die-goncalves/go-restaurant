...
export function MapRegionAndPartners({ geoJSON }: MapRegionAndPartnersProp) {
  ...
  return (
    <div
      ...
      className={css({
        ...
        '& .restaurant-container': { display: 'flex' },
        '& .restaurant-img': { w: '24', objectFit: 'cover' },
        '& .restaurant-content': { p: '2' },
        '& .restaurant-content span': {
          fontSize: 'base',
          fontFamily: 'sans',
          color: 'light.gray.800'
        },
        '& .restaurant-header': { display: 'flex', flexDirection: 'column' },
        '& .restaurant-header > div': {
          display: 'flex',
          justifyContent: 'space-between'
        },
        '& .restaurant-header div:first-child span': { fontWeight: 'medium' },
        '& .restaurant-phone': { display: 'flex', gap: '2', mr: 'auto' },
        ...
        '& .restaurant-icon-star': { w: '6', h: '6' },
        '& .restaurant-icon-phone': { w: '6', h: '6' },
        '& .restaurant-icon-phone path': {
          stroke: 'token(colors.light.gray.800)'
        },
        '2xs': {
          '& .mapboxgl-popup-content': { w: '64' }
        },
        '3xs': {
          '& .mapboxgl-popup-content': { w: '52' },
          '& .restaurant-img': { display: 'none' }
        },
        sm: {
          '& .mapboxgl-popup-content': { w: '96' },
          '& .restaurant-img': { display: 'inline-flex', minH: 'full' }
        }
      })}
    />
  )
