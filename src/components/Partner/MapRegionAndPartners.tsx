...
export default function MapRegionAndPartners({
  ...
  function flyToStore(currentFeature: any) {
    if (map.current)
      map.current.flyTo({
        center: [
          currentFeature.geometry.coordinates[0] - 0.01,
          currentFeature.geometry.coordinates[1] + 0.0008
        ],
        zoom: 14
      })
  }
  ...
  useEffect(() => {
    map.current = new mapboxgl.Map({
      ...
      center: [-42.529554090729704, -19.476649522015165],
      zoom: 7
    })
  ...
  return (
    <div
      ...
      className={clsx(
        ...
        '[&_.mapboxgl-popup-content]:border-2 [&_.mapboxgl-popup-content]:border-light-gray-200 [&_.mapboxgl-popup-content]:drop-shadow-lg [&_.mapboxgl-popup-content]:p-0 [&_.mapboxgl-popup-content]:bg-light-gray-100 [&_.mapboxgl-popup-content]:rounded [&_.mapboxgl-popup-content]:w-96',
        '[&_.restaurant-container]:flex',
        '[&_.restaurant-img]:h-40 [&_.restaurant-img]:w-24 [&_.restaurant-img]:object-cover',
