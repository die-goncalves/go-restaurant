...
const log = logger.child({ module: 'client', component: 'AddressSelector' })
            ...
            {({ setOpen }) => (
              <>
                ...
                >
                  ...
                  >
                    <p>Mova o mapa para definir o ponto de entrega</p>
                  </Dialog.Description>
                  ...
                  >
                    {mapReady && <Map onChange={handleSetCoordinates} />}
                  </div>
                </main>
