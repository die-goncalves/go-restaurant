...
import { FilterAltIcon } from '@/src/components/icons/filter-alt'
...
export function SidebarCompact({ categories }: Pick<Data, 'categories'>) {
  const {
    state,
    toggleCategory,
    setPriceRange,
    ...
    >
      ...
      <Dialog.Root size="md">
        <Dialog.Trigger asChild>
          <Button variant="solid" icon={<FilterAltIcon />} iconPlacement="left">
            Filtros
          </Button>
        </Dialog.Trigger>
